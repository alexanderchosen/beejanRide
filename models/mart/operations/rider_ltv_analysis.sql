...
with rider_valued as (
    ...
    select r.rider_id, r.country, r.signup_date, r.days_since_signup, r.referral_code, r.is_referred_rider, r.rider_level,

        -- Trip behaviour
        r.total_trips, r.completed_trips, r.cancelled_trips, r.no_show_trips,
        ...
        -- Payment integrity
        r.missing_payment_count, r.duplicate_payment_count, r.failed_payment_on_completed_count, r.invalid_payment_amount_count,
...
select
    -- Identity
    v.rider_id, v.country, v.signup_date, v.days_since_signup, v.referral_code, v.is_referred_rider, v.acquisition_cohort, v.rider_level,

    -- Trip behaviour
    v.total_trips, v.completed_trips, v.cancelled_trips, v.no_show_trips,

    -- Revenue & LTV
    v.rider_lifetime_value, v.ltv_per_day, v.ltv_percentile, v.ltv_segment,

    -- Preferred city (with name from dim_cities)
    v.most_frequent_city_id, c.city_name as most_frequent_city_name,

    -- Surge & corporate behaviour
    v.extreme_surge_trips, v.corporate_trips,

    -- Payment integrity
    v.missing_payment_count, v.duplicate_payment_count, v.failed_payment_on_completed_count, v.invalid_payment_amount_count, v.total_payment_issues
